...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['type' => 'text','id' => 'judul','name' => 'judul','value' => ''.e(old('judul', $laporan->judul)).'','required' => true,'class' => 'mt-1 block w-full @error(\'judul\') border-red-500 @enderror','placeholder' => 'Contoh: Saluran air tersumbat di Jl. Mawar']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','id' => 'judul','name' => 'judul','value' => ''.e(old('judul', $laporan->judul)).'','required' => true,'class' => 'mt-1 block w-full @error(\'judul\') border-red-500 @enderror','placeholder' => 'Contoh: Saluran air tersumbat di Jl. Mawar']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        <textarea id="deskripsi" name="deskripsi" rows="5" required
                                  class="mt-1 block w-full border-gray-300 rounded-xl shadow-sm focus:border-indigo-500 focus:ring-indigo-500 <?php $__errorArgs = ['deskripsi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginal18c21970322f9e5c938bc954620c12bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['type' => 'text','id' => 'lokasi','name' => 'lokasi','value' => ''.e(old('lokasi', $laporan->lokasi)).'','required' => true,'class' => 'mt-1 block w-full @error(\'lokasi\') border-red-500 @enderror','placeholder' => 'Contoh: Nama jalan, RT/RW, Kecamatan']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','id' => 'lokasi','name' => 'lokasi','value' => ''.e(old('lokasi', $laporan->lokasi)).'','required' => true,'class' => 'mt-1 block w-full @error(\'lokasi\') border-red-500 @enderror','placeholder' => 'Contoh: Nama jalan, RT/RW, Kecamatan']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
...
<?php if(Auth::user()->isAdmin()): ?>
    <div class="mt-4">
        <?php if (isset($component)) { $__componentOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'status','value' => __('Ubah Status Laporan')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'status','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Ubah Status Laporan'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581)): ?>
<?php $attributes = $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581; ?>
...
<?php endif; ?>
        <select name="status" id="status" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm">
            <option value="Dilaporkan" <?php if(old('status', $laporan->status) == 'Dilaporkan'): echo 'selected'; endif; ?>>Dilaporkan</option>
            <option value="Diproses" <?php if(old('status', $laporan->status) == 'Diproses'): echo 'selected'; endif; ?>>Diproses</option>
            <option value="Selesai Ditangani" <?php if(old('status', $laporan->status) == 'Selesai Ditangani'): echo 'selected'; endif; ?>>Selesai Ditangani</option>
        </select>
    </div>
<?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-4">
                            ...
                            <img src="<?php echo e(asset('storage/' . $laporan->foto)); ?>" alt="Foto saat ini" class="w-48 h-auto object-cover rounded-lg shadow-md border border-gray-200">
                        </div>
                        <?php endif; ?>
                    </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.danger-button','data' => ['type' => 'button','xData' => '','xOn:click.prevent' => '$dispatch(\'open-modal\', \'confirm-laporan-deletion\')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','x-data' => '','x-on:click.prevent' => '$dispatch(\'open-modal\', \'confirm-laporan-deletion\')']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'text-base font-bold bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-700 hover:to-emerald-700 focus:ring-teal-300']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-base font-bold bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-700 hover:to-emerald-700 focus:ring-teal-300']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'confirm-laporan-deletion','focusable' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['name' => 'confirm-laporan-deletion','focusable' => true]); ?>
                    <form method="post" action="<?php echo e(route('laporan.destroy', $laporan)); ?>" class="p-6">
                        ...
                        <h2 class="text-lg font-medium text-gray-900">
                            <?php echo e(__('Konfirmasi Hapus Laporan')); ?>

                        </h2>

                        <p class="mt-1 text-sm text-gray-600">
                            <?php echo e(__('Apakah Anda benar-benar yakin ingin menghapus laporan ini? Data yang dihapus tidak dapat dikembalikan.')); ?>
...
<?php $component->withAttributes(['class' => 'ms-3']); ?>
                                <?php echo e(__('Ya, Hapus Laporan')); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\LaporLingkungan\resources\views/laporan/edit.blade.php ENDPATH**/ ?>